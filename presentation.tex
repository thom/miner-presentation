...
\begin{frame}{Improve Bug Finding Techniques}
  \begin{thebibliography}
    \beamertemplatearticlebibitems
  \bibitem{improve-bug-finding-techniques}
    C. Williams, J. Hollingsworth, {\em Automatic Mining of Source
      Code Repositories to Improve Bug Finding Techniques}
  \end{thebibliography}
